...
class KnowledgeManager:
    ...
    def get_file_loader(self,filename: str, file_path: str, file_content_type: str=None):
        """Delegate loader resolution to shared file_loader module for reuse."""
        from agi.tasks.file_loader import get_file_loader

        return get_file_loader(file_path=file_path, file_content_type=file_content_type)
    # decrease
