...
CONTEXT_MAX_TOOL_OUTPUT_LENGTH = get_env_int("CONTEXT_MAX_TOOL_OUTPUT_LENGTH", 4000)
CONTEXT_PREVIEW_TOOL_TEXT_LENGTH = get_env_int("CONTEXT_PREVIEW_TOOL_TEXT_LENGTH", 800)
